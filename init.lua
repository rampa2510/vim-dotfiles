...
-- Accelerated JK mapping
vim.keymap.set('n', 'j', '<Plug>(accelerated_jk_gj)', { desc = ' Accelerated down movement' })
vim.keymap.set('n', 'k', '<Plug>(accelerated_jk_gk)', { desc = ' Accelerated up movement' })
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      -- Normal mode mappings (new format)
      ...
      -- Visual mode mappings (new format)
      require('which-key').add {
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'javascript', 'typescript', 'ruby' },
